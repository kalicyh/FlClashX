...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "enableNotificationsDesc": MessageLookupByLibrary.simpleMessage(
          "Если выключено, уведомления остаются видимыми, но их содержимое не обновляется",
        ),
        ...
        "noExpireInfo": MessageLookupByLibrary.simpleMessage(
        ...
        "noTrafficInfo": MessageLookupByLibrary.simpleMessage(
          "Нет информации о трафике",
        ),
        ...
        "overrideMode":
            MessageLookupByLibrary.simpleMessage("Режим перезаписи"),
        "overrideScript":
            MessageLookupByLibrary.simpleMessage("Скрипт перезаписи"),
        ...
        "proxyModeButton": MessageLookupByLibrary.simpleMessage(
          "Кнопка глобального режима/правил на странице прокси",
        ),
        "proxyDelayButton": MessageLookupByLibrary.simpleMessage(
          "Кнопка проверки задержки на странице прокси",
        ),
        "proxyExpandButton": MessageLookupByLibrary.simpleMessage(
          "Кнопка раскрытия всех групп на странице прокси",
        ),
        "pureBlackMode":
        ...
        "scriptModeDesc": MessageLookupByLibrary.simpleMessage(
          "Скриптовый режим запускает выбранную JavaScript-перезапись для этого профиля.",
        ),
        ...
        "standardModeDesc": MessageLookupByLibrary.simpleMessage(
          "Стандартный режим использует перезапись правил и добавленные правила.",
        ),
