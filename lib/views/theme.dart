...
class _ProxyActionButtonsItem extends ConsumerWidget {
  const _ProxyActionButtonsItem();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = [
      (
        icon: Icons.rule,
        title: appLocalizations.proxyModeButton,
        value: themeProps.showProxyModeButton,
        update: (bool value) => themeProps.copyWith(
              showProxyModeButton: value,
            ),
      ),
      (
        icon: Icons.network_ping,
        title: appLocalizations.proxyDelayButton,
        value: themeProps.showProxyDelayButton,
        update: (bool value) => themeProps.copyWith(
              showProxyDelayButton: value,
            ),
      ),
      (
        icon: Icons.unfold_more,
        title: appLocalizations.proxyExpandButton,
        value: themeProps.showProxyExpandButton,
        update: (bool value) => themeProps.copyWith(
              showProxyExpandButton: value,
            ),
      ),
    ];
